...
router.get("/api/auth/sessions", authController.sessions);
router.get("/api/auth/signout", authController.signout);
router.post("/api/auth/signoutsession", authController.logoutofSession);
...
// Notificatiions and Push Notificatons.

router.post("/api/push/token", pushController.setToken);
router.get('/api/notifications',pushController.getAllNotification);
router.put('/api/notifications',pushController.markReadNotification);
router.get('/api/send',pushController.sendPush);
